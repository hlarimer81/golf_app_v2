                    ...
                    return (
                      <td key={`f-${i}`} style={{ padding: '3px', textAlign: 'center', borderLeft: '1px solid #2a2a2a', backgroundColor: holePoints === 5 ? '#00BCD433' : (i + 1) % 2 === 0 ? '#1a1a1a' : '#1e1e1e', position: 'relative', minWidth: '50px' }}>
                        <div style={{ position: 'absolute', top: '2px', left: '3px', display: 'flex', gap: '1px' }}>
                          {hasOneStroke && <div style={{ width: '4px', height: '4px', backgroundColor: '#00BCD4', borderRadius: '50%' }} />}
                          {hasTwoStrokes && <div style={{ width: '4px', height: '4px', backgroundColor: '#00BCD4', borderRadius: '50%' }} />}
                        </div>
                        <input id={`score-${holeNum}-${globalIdx}`} type="tel" inputMode="numeric" value={strokes || ''} onChange={(e) => handleScoreChange(holeNum, e.target.value)}
                          style={{ width: '34px', height: '34px', textAlign: 'center', backgroundColor: holePoints === 5 ? '#00BCD444' : '#2a2a2a', color: net !== null ? scoreColor(net, par) : '#fff', border: holePoints === 5 ? '2px solid #00BCD4' : '1px solid #444', borderRadius: '4px', fontSize: '16px', outline: 'none' }} />
                        ...
                        {holePoints !== undefined && <div style={{ position: 'absolute', bottom: '1px', right: '3px', fontSize: '10px', color: '#00BCD4', fontWeight: 'bold' }}>{holePoints}p</div>}
                      </td>
                    );
                  })}
