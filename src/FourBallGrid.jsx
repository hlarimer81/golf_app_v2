                        ...
                        {[...Array(9)].map((_, i) => {
                          ...
                          return (
                            <td key={`f-${i}`} style={{ padding: '3px', textAlign: 'center', borderLeft: '1px solid #2a2a2a', backgroundColor: (i + 1) % 2 === 0 ? '#1a1a1a' : '#1e1e1e', position: 'relative', minWidth: '50px' }}>
                              ...
                              {useQuota && strokes > 0 && (
                                <div style={{ position: 'absolute', bottom: '1px', right: '3px', fontSize: '8px', fontWeight: '700', color: pts >= 3 ? '#4CAF50' : pts === 2 ? '#888' : '#ff9800', background: 'rgba(0,0,0,0.5)', padding: '0 3px', borderRadius: '2px' }}>
                                  {pts}
                                </div>
                              )}
                            </td>
